...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function injectButton() {
        ...
        // Removido bloco de instruções para simplificar interface
        /*
        if (!document.getElementById('webcamfoto-instructions')) {
            ...
            instructions.innerHTML = `
                ...
                <ol>
                    ...
                    <li>Uma nova janela será aberta já vinculada ao produto #${productId}</li>
                    <li>Arraste essa janela para qualquer monitor e use normalmente</li>
                </ol>
                <p><em>Esta versão foi criada para facilitar o uso multi-monitor.</em></p>
            `;
        ...
        */
        ...
        // Monta URL para a nova página PHP, passando o ID do produto diretamente
        const basePath = window.location.pathname.substring(0, window.location.pathname.indexOf('/product/'));
        const webcamPageUrl = basePath + '/custom/webcamfoto/webcam_page.php?id=' + encodeURIComponent(productId);
        ...
        // Removido mouseover que mostrava instruções
        /*
